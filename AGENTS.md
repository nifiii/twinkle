...
This project is indexed by GitNexus as **twinkle** (1873 symbols, 3612 relationships, 129 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/twinkle/context` | Codebase overview, check index freshness |
| `gitnexus://repo/twinkle/clusters` | All functional areas |
| `gitnexus://repo/twinkle/processes` | All execution flows |
| `gitnexus://repo/twinkle/process/{name}` | Step-by-step execution trace |
